...
inline std::string phoneAppModeToString(PhoneAppMode mode)
{
    switch (mode)
    {
        ...
        case PhoneAppMode::SPELLS:       return "Spells";
        case PhoneAppMode::PERKS:        return "Perk Tree";
        case PhoneAppMode::CONTACTS:     return "Contacts";
        case PhoneAppMode::STATS:        return "Stats";
        case PhoneAppMode::MAPS:         return "Maps";
...
{
public:
    explicit phoneAppsState(PhoneAppMode mode = PhoneAppMode::QUESTS);
    ...
    void setAppMode(PhoneAppMode mode) { m_mode = mode; m_selectedItemIndex = 0; }
...
private:
    PhoneAppMode m_mode = PhoneAppMode::QUESTS;
